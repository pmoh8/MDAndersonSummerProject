...
#END TEST VALUES
  ...
  output$plot<- renderPlot({ 
    ggplot(testdata, aes(x,y)) + geom_point(aes(alpha=.5, color="blue"))
  ...
  output$plot_zoom<- renderPlot({ 
    print("zoom")
    plotdata$zoomdata <- brushedPoints(testdata,input$plot_brush)
    ggplot(plotdata$zoomdata, aes(x,y)) + geom_point(aes(alpha=.5, color="blue"))
  }) 
