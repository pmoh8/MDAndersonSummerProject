  ...
  ##################################
    ...
    output$plot<- renderPlot({ 
      ...
      if(TRUE){
        ...
        defaultplotdata$cancer = cancer_type
        defaultplotdata$line = cell_line
        #print(head(defaultplotdata))
        print(cancer_highlights())

        highlightDF <- defaultplotdata[defaultplotdata$cancer %in% cancer_highlights(),]
        print(head(highlightDF))
